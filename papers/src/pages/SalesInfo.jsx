...
import SalesDocumentsTable from './SalesDocumentsTable'; // Importamos la tabla
import '../components/SalesInfo.css';

function SalesInfo({ sales }) { // Recibe el 'sales' fetchado de Sells.jsx
  return (
    <div className="sales-info-view">
      ...
      {/* Le pasamos la prop 'sales' que viene de Sells.jsx */}
      <SalesDocumentsTable sales={sales} />
